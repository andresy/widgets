...
Widget.__initAttributes = argcheck{
   {name="self", type="gui.Widget"},
   {name="attr", type="table"},
   call =
      function(self, attr)
...
Widget.updateGeometry = argcheck{
   {name="self", type="gui.Widget"},
   call =
      function(self)
...
Widget.isGeometryReady = argcheck{
   {name="self", type="gui.Widget"},
   call =
      function(self)
